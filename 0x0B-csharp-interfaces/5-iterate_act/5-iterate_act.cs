...
{
    /// <summary>Check: object is being carried or yet to be found.</summary>
...
public class Decoration : Base, IBreakable, IInteractive
{
    ...
    /// <summary>Check: if item is essential to game progress.</summary>
...
{
    /// <summary>Check: if is a carried key or hidden one.</summary>
